...
## How I Used It
### Improve Code Quality (Windsurf IDE)
...
### Improve Code Quality (GitHub Copilot on Vscode)
...
### Create User Guide (GitHub Copilot on Vscode)
...
### Tweak GUI (GitHub Copilot on Vscode)
I used GitHub Copilot on Auto model setting to assist with improving the GUI. I specified for it to add a banner to the top of the GUI, reduce the profile picture size and also reduce the gaps between the dialog boxes. Some of it did not turn out as expected and I had to make further changes to ensure it was what I wanted.
